...
**4. What changed between the second and fourth commits in `index.js`?**

Command to use: `git diff <hash1> <hash2> -- index.js`

Answer:

**5. Which commit added the `listItems` function?**

Command to use: `git log -p -- index.js` (search through the patches)
